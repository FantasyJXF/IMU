...
uint8_t I2C_ByteWrite(u8 pBuffer, u8 WriteAddr)
{
  ...
  I2C_Send7bitAddress(macI2Cx, MPU6050_SLAVE_ADDRESS, I2C_Direction_Transmitter);
...
{  
  ...
  /* Send the slave's internal address to write to */
  I2C_SendData(macI2Cx, ReadAddr);  // 要写入的从设备寄存器地址
  ...
  I2C_Send7bitAddress(macI2Cx, MPU6050_SLAVE_ADDRESS, I2C_Direction_Receiver);
